...
[
  ...
  'Mika',           'Mona',               'Mualani',
  'Nahida',         'Navia',              'Nefer',
  'Neuvillette',    'Nicole',             'Nilou',
  'Ningguang',      'Noelle',             'Odette',
  'Ororon',         'Prune',              'Qiqi',
  'Raiden Shogun',  'Razor',              'Rosaria',
  'Sandrone',       'Sangonomiya Kokomi', 'Sayu',
...
```js
[ 'Amber', 'Collei', 'Dahlia', 'Diona', 'Fischl', 'Lohen' ]
```
...
```js
{
  ...
  filename: [ 'amber', 'collei', 'dahlia', 'diona', 'fischl', 'lohen' ],
  result: [ 'アンバー', 'コレイ', 'ダリア', 'ディオナ', 'フィッシュル', 'ローエン' ]
}
```
...
[
  ...
  'Nicole',             'Nilou',            'Ningguang',
  'Noelle',             'Odette',           'Ororon',
  'Prune',              'Qiqi',             'Raiden Shogun',
  'Razor',              'Rosaria',          'Sandrone',
...
[
  ...
  'Cool Steel',           'Disaster and Remorse',
...
[
  ...
  'Frostpetal Starbloom Fish',
  'Glaze Medaka',
  'Golden Koi',
  'Greenwave Sunfish',
  'Halcyon Jade Axe Marlin',
  'Iridescent Starbloom Fish',
...
[
  ...
  'Flour',           'Fowl',         'Glabrous Beans',  'Glaciafruit',
  'Grainfruit',      'Ham',          'Harra Fruit',     'Honey',
  'Jam',             'Lakkaberry',   'Lavender Melon',  'Lotus Head',
  'Marcotte',        'Matsutake',    'Midsommar Berry', 'Milk',
  'Mint',            'Mushroom',     'Mysterious Meat', 'Onion',
  'Pepper',          'Pinecone',     'Potato',          'Radish',
  'Raw Meat',        'Red Beet',     'Red Berryshroom', 'Rice',
  'Rimecurrant',     'Rye',          'Rye Flour',       'Salt',
  'Sausage',         'Seagrass',     'Shrimp Meat',     'Silver Lotus',
  'Smetana',         'Smoked Fish',  'Smoked Fowl',     'Snapdragon',
  'Snowball Flower', 'Spice',        'Spinel Fruit',    'Sugar',
  'Sumeru Rose',     'Sweet Flower', 'Tidalga',         'Tofu',
  'Tomato',          'Wheat',        'Windrest Flower', 'Zaytun Peach'
]
```
...
[
  ...
  'Domain of Blessing: Flower Feast I',
  'Domain of Blessing: Flower Feast II',
  'Domain of Blessing: Flower Feast III',
  'Domain of Blessing: Flower Feast IV',
  'Domain of Blessing: Harmony I',
  'Domain of Blessing: Harmony II',
  'Domain of Blessing: Harmony III',
  'Domain of Blessing: Harmony IV',
  'Domain of Blessing: Ice Erosion I',
  'Domain of Blessing: Ice Erosion II',
  'Domain of Blessing: Ice Erosion III',
  'Domain of Blessing: Ice Erosion IV',
  ...
  'Domain of Forgery: Cast Iron I',
  'Domain of Forgery: Cast Iron II',
  'Domain of Forgery: Cast Iron III',
  'Domain of Forgery: Cast Iron IV',
  'Domain of Forgery: Chain Track I',
  'Domain of Forgery: Chain Track II',
  'Domain of Forgery: Chain Track III',
  'Domain of Forgery: Chain Track IV',
  ...
  'Domain of Forgery: Severed Steel I',
  'Domain of Forgery: Severed Steel II',
  'Domain of Forgery: Severed Steel III',
  'Domain of Forgery: Severed Steel IV',
...
[
  ...
  'Domain of Mastery: Shared Vision I',
  'Domain of Mastery: Shared Vision II',
  'Domain of Mastery: Shared Vision III',
  'Domain of Mastery: Shared Vision IV',
  'Domain of Mastery: Vine-Infested Ruins I',
  'Domain of Mastery: Vine-Infested Ruins II',
  'Domain of Mastery: Vine-Infested Ruins III',
  'Domain of Mastery: Vine-Infested Ruins IV'
...
```js
{
  ...
  rewardPreview: [
    { id: 202, name: 'Mora' },
    { id: 112004, name: 'Slime Concentrate', count: 0.045 },
    { id: 112003, name: 'Slime Secretions', count: 0.179 },
    { id: 112002, name: 'Slime Condensate', count: 0.672 }
  ],
  images: {
