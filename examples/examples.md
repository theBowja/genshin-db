...
[
  ...
  'Charlotte',    'Chevreuse',          'Chiori',
  'Chongyun',     'Clorinde',           'Collei',
  'Cyno',         'Dehya',              'Diluc',
  'Diona',        'Dori',               'Emilie',
  'Eula',         'Faruzan',            'Fischl',
...
[
  ...
  'Sayu',             'Sethos',            'Shenhe',
  'Shikanoin Heizou', 'Sigewinne',         'Sucrose',
...
[
  ...
  'Cheese',          'Chenyu Adeptea',  'Chilled Meat',
  'Coffee Beans',    'Crab',            'Crab Roe',
  'Cream',           'Dried Fish',      'Eel Meat',
  'Fermented Juice', 'Fish',            'Flour',
  'Fowl',            'Glabrous Beans',  'Grainfruit',
  'Ham',             'Harra Fruit',     'Jam',
  'Lavender Melon',  'Lotus Head',      'Marcotte',
  'Matsutake',       'Milk',            'Mint',
  'Mushroom',        'Mysterious Meat', 'Onion',
  'Pepper',          'Pinecone',        'Potato',
  'Radish',          'Raw Meat',        'Rice',
  'Salt',            'Sausage',         'Seagrass',
  'Shrimp Meat',     'Silver Lotus',    'Smoked Fish',
  'Smoked Fowl',     'Snapdragon',      'Spice',
  'Spinel Fruit',    'Sugar',           'Sumeru Rose',
  'Sweet Flower',    'Tidalga',         'Tofu',
